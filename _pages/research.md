...
- **Hunting in Zebrafish** — *DeepRL RNNs dissect larval hunting*  
  ...
  **[NeurIPS 2025 AI4Science (Spotlight)](https://openreview.net/forum?id=3kiCmoOQz7#discussion)**, **[Preprint](https://arxiv.org/abs/2510.03699)**  
  <div style="display: flex; justify-content: center; gap: 10px; flex-wrap: wrap; align-items: center;">
    <img src="/files/zf1_cropped.gif" alt="Zebrafish hunting closeup" style="max-width: 48%;" />
    <img src="/files/zf4_cropped.gif" alt="Zebrafish collective foraging" style="max-width: 48%;" />
  </div>
...
- **InputDSA** — *demix recurrent vs input-driven dynamics*  
  *Huang AH, Ostrow M, Singh SH, et al.* **CoSyNe 2026 (Spotlight Talk), ICLR 2026 (accepted) [ArXiV](https://arxiv.org/abs/2510.25943)** — **Demixing then Comparing Recurrent and Externally Driven Dynamics** 
